	...
	then
		...
		then
			...
			then
				...
				convert $imagedir/$pic1 -quality 100 -auto-gamma -gravity SouthEast -font Liberation-Mono -fill yellow -annotate 0 "$insstring" $diffdir/$pic1
			fi
			rm -f $imagedir/$pic1
			...
			then
				...
				convert $imagedir/$pic2 -quality 100 -auto-gamma -gravity SouthEast -font Liberation-Mono -fill yellow -annotate 0 "$insstring" $diffdir/$pic2
			fi
