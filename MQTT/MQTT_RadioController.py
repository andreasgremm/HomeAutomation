...
if __name__ == '__main__':
	...
	parser.add_argument('-c', '--client-id', help="Id des Clients", dest="clientID", default="MQTT_Webradio")
	...
	parser.add_argument('-rk', '--radio-key', help="Key fuer das Webradio", dest="radioKey", default=DefaultFSAPIKey)
	parser.add_argument('-rh', '--radio-host', help="Hostname/IP fuer das Webradio", dest="radioHost", default='192.168.1.104')
